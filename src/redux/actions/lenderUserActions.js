...
export const createLenderUser = createAsyncThunk(
  "lenderUser/createLenderUser",
  async (lenderUserData, { getState }) => {
...
export const getLenderUsers = createAsyncThunk(
  "lenderUser/fetchLenderUsers",
  async () => {
    try {
...
export const fetchLenderUserById = createAsyncThunk(
  "lenderUser/fetchLenderUserById",
  async (id) => {
