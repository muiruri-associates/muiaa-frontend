...
export const getAllAvailableLeads = createAsyncThunk(
  "leads/getAllAvailableLeads",
  async (lender_id, { getState }) => {
    try {
      ...
      const response = await axiosInstance.get(
        `/lenders/${lender_id}/available-leads`,
        config
      );
...
export const fetchLenderOrgById = createAsyncThunk(
  "lenderOrg/fetchLenderOrgById",
  async (id, { getState }) => {
