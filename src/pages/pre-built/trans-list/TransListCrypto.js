                ...
                <Row className="g-gs">
                  <Col md="6">
                    <FormGroup>
                      ...
                      />
                      {errors.amountBTC && (
                        <span className="invalid">{errors.amountBTC.message}</span>
                      )}
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                      ...
                      />
                      {errors.amountUSD && (
                        <span className="invalid">{errors.amountUSD.message}</span>
                      )}
                    </FormGroup>
                  </Col>
                </Row>
                ...
                <Row className="gy-4">
                  <Col md="6">
                    <FormGroup>
                      ...
                      />
                      {errors.balanceBTC && (
                        <span className="invalid">{errors.balanceBTC.message}</span>
                      )}
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                      ...
                      />
                      {errors.balanceUSD && (
                        <span className="invalid">{errors.balanceUSD.message}</span>
                      )}
                    </FormGroup>
                  </Col>
                  <Col size="12">
