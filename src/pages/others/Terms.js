            ...
            <BlockHeadContent className="text-center">
              ...
              <BlockDes>
                <p className="lead">
                  ...
                  terms, as well as our Policy and Terms of Service, apply to all users.
                </p>
            ...
            <PreviewCard className="card-bordered">
              <div className="entry">
                ...
                <p>
                  ...
                  <strong>Creative Commons</strong> license. You can grab a copy of
                  these Terms and other legal documents on Github. You’re more than
                  welcome to copy them, adapt them, and repurpose them for your own use.
                </p>
                <h4>Introduction</h4>
                <p>
                ...
                <p>
                  ...
                  third-party&ldquo;s rights. Company Name reserves the right to remove
