...
export const ticketChatUserData = [
  {
    id: 1,
...
//   ticketChatData.sort(function (a, b) {
//     return a.name === b.name ? 0 : a.name < b.name ? -1 : 1;
//   });
//   return ticketChatData.filter((item) => array.includes(item.name.split("")[0].toUpperCase()) && !item.group);
// };
...
//     return a.name === b.name ? 0 : a.name < b.name ? -1 : 1;
//   });
//   return ticketChatData.filter((item) => array.includes(item.name.split("")[0].toUpperCase()) && item.fav === false);
// };
