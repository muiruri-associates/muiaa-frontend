...
const NioIconPage = React.lazy(
  () => import("../pages/components/crafted-icons/NioIcon")
);
const SVGIconPage = React.lazy(
  () => import("../pages/components/crafted-icons/SvgIcons")
);
const LenderOrganizations = React.lazy(
  () => import("../pages/main/lender/LenderOrganizations")
);
const CreateLenderOrganizations = React.lazy(
  () => import("../pages/main/lender/CreateLenderOrganizations")
);
...
const ViewLenderOrganizationPage = React.lazy(
  () => import("../pages/main/lender/ViewLenderOrganizationPage")
);
...
const AddPermission = React.lazy(
  () => import("../pages/main/accessControl/AddPermission")
);
const CreateLenderUser = React.lazy(
  () => import("../pages/main/lender/CreateLenderUser")
);
...
const UserProfileInfo = React.lazy(
  () => import("../mainComponents/Profile/UserProfileInfo")
);
const UploadsPage = React.lazy(() => import("../pages/main/borrower/UploadsPage"));
const TransactionsPage = React.lazy(
  () => import("../pages/main/borrower/TransactionsPage")
);
const BorrowerLoansPage = React.lazy(
  () => import("../pages/main/borrower/BorrowerLoansPage")
);
const RequestedLoansPage = React.lazy(
  () => import("../pages/main/borrower/RequestedLoansPage")
);
const ApprovedLoansPage = React.lazy(
  () => import("../pages/main/borrower/ApprovedLoansPage")
);
const RejectedLoansPage = React.lazy(
  () => import("../pages/main/borrower/RejectedLoansPage")
);
const ContactLenderPage = React.lazy(
  () => import("../pages/main/borrower/ContactLenderPage")
);
const ContactUserPage = React.lazy(
  () => import("../pages/main/borrower/ContactUserPage")
);
    ...
    <Suspense fallback={<div>Loading...</div>}>
      <Switch>
        ...
        <PrivateRoute
          ...
          allowedRoles={[ROLE.Lender]}
        />
        <PrivateRoute
          exact
          path={`/loans`}
          component={Loans}
          allowedRoles={[ROLE.Admin, ROLE.Lender]}
        />
        <PrivateRoute
          exact
          path={`/leads`}
        ...
        <PrivateRoute
          exact
          path={`/lender-organizations`}
          component={LenderOrganizations}
          allowedRoles={[ROLE.Admin]}
        />
        <PrivateRoute
          exact
          path={`/create-lender-organizations`}
          component={CreateLenderOrganizations}
          allowedRoles={[ROLE.Admin]}
        />
        <PrivateRoute
          exact
          path={`/create-lender-user`}
          component={CreateLenderUser}
          allowedRoles={[ROLE.Admin]}
        />
        <PrivateRoute
          exact
          path={`/lender-organization/:id`}
          component={ViewLenderOrganizationPage}
          allowedRoles={[ROLE.Admin]}
        />
        <PrivateRoute
          exact
        ...
        <PrivateRoute
          ...
          path={`/profile`}
          component={Profile}
          allowedRoles={[ROLE.Admin, ROLE.Lender, ROLE.User]}
        />
        <PrivateRoute
          exact
        ...
        <PrivateRoute
          exact
          path={"/contact-lender"}
          component={ContactLenderPage}
          allowedRoles={[ROLE.User]}
        />
        <PrivateRoute
          exact
          path={"/contact-user"}
          component={ContactUserPage}
          allowedRoles={[ROLE.Lender]}
        />
        <PrivateRoute
          exact
        ...
        <PrivateRoute
          ...
          path={"/ticket"}
          component={Ticket}
          allowedRoles={[ROLE.Lender, ROLE.User]}
        />
        <PrivateRoute
          exact
          path={"/my-tickets"}
